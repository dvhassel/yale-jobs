...
"""
Yale-adapted Nanonets-OCR2 script for use with Yale HPC Jobs.
Based on: https://huggingface.co/datasets/uv-scripts/ocr/blob/main/nanonets-ocr2.py
...
def main(
    ...
    """Process images from dataset through Nanonets-OCR2-3B model.
    ...
    logger.info("✅ Nanonets-OCR2 processing complete!")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        print("=" * 80)
        print("Yale Nanonets-OCR2 Document Processing")
        print("=" * 80)
        print("\nState-of-the-art OCR with Nanonets-OCR2-3B (3.75B params) for Yale HPC")
        print("\nFeatures:")
        print("- 📐 LaTeX equation recognition")
        print("- 📊 Table extraction and formatting (HTML)")
        print("- 📝 Document structure preservation")
        print("- 🖼️ Image descriptions and captions")
        print("- 🔖 Signature and watermark detection")
        print("- ☑️ Checkbox recognition (☐/☑)")
        ...
        print("   python nanonets2-ocr.py dataset_path output_path --load-from-disk-path")
        print("\n" + "=" * 80)
        print("\nFor full help, run: python nanonets2-ocr.py --help")
        sys.exit(0)

    parser = argparse.ArgumentParser(
        description="Document OCR using Nanonets-OCR2-3B for Yale HPC",
